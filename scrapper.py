...
browser = webdriver.Chrome("C:/Users/Feroz/OneDrive/Python/Classes/Class 127/Venv/chromedriver.exe")
...
def scrapper():
    ...
    for i in range(0, 456):
        ...
        browser.find_element_by_xpath('//*[@id="primary_column"]/footer/div/div/div/nav/span[2]/a').click()
        print("The page finished scrapping: " , page_num)
    ...
    try:
        ...
        for tr_tag in soup.find_all("tr", attrs = {"class": "fact_row"}):
            ...
            for td_tag in td_tags:
                try:
                    temp_list.append(td_tag.find_all("div", atters = {"class": "value"})[0].contents[0])
...
for index, data in enumerate(planet_data):
    ...
    print("Page 2 From Each Link", index + 1)
